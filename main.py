...
m = str(input("What method should be used? [L]RAM, [M]RAM, [R]RAM\n").replace(" ", "").replace("L", "l").replace("M", "m").replace("R", "r").replace("LRAM", "l").replace("MRAM", "m").replace("RRAM", "r").replace("lram", "l").replace("mram", "m").replace("rram", "r").replace("[L]RAM", "l").replace("[M]RAM", "m").replace("[R]RAM", "r").replace("[l]ram", "l").replace("[m]ram", "m").replace("[r]ram", "r"))
delta_x = (b-a)/p
